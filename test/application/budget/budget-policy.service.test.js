...
const BudgetPolicyService = require('../../../src/application/services/budget/budget-policy.service');

describe('T090: Budget Policy Service', () => {
  test('evaluates budget limits correctly', () => {
    const service = new BudgetPolicyService({ dailyCostCap: 10, warningThresholdPercent: 80 });
