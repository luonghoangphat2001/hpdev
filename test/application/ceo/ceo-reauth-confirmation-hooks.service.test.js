...
const CeoReauthConfirmationHooksService = require('../../../src/application/services/ceo/ceo-reauth-confirmation-hooks.service');
...
describe('T149: CEO Re-Auth, Confirmation, and Dual-Control Hooks Service', () => {
  test('executes dangerous action upon valid re-authentication', () => {
    const service = new CeoReauthConfirmationHooksService();
