...
const DailyReportSchedulerService = require('../../../src/application/services/reporting/daily-report-scheduler.service');
...
describe('DailyReportSchedulerService', () => {
  test('sends once after configured local time and skips duplicate ticks', async () => {
    ...
    const scheduler = new DailyReportSchedulerService({
      aggregator,
