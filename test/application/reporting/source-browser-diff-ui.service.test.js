...
const SourceBrowserDiffUiService = require('../../../src/application/services/reporting/source-browser-diff-ui.service');

describe('T153: Source Browser and Diff API/UI Service', () => {
  test('returns sanitized source code and branch/commit diffs', async () => {
    const service = new SourceBrowserDiffUiService({});
