...
const CustomerInsightAggregatorService = require('../../../src/application/services/research/customer-insight-aggregator.service');
...
describe('T099: Customer Insight Aggregator Service', () => {
  test('aggregates and redacts PII from reviews and tickets', () => {
    ...
    const service = new CustomerInsightAggregatorService({ piiRedactorService: mockPii });
