...
const CuratedMemorySchemaStoreService = require('../../../src/application/services/memory/curated-memory-schema-store.service');
...
describe('T166: Curated Memory Schema/Store Service', () => {
  test('creates curated memory entry with confidence, scope, TTL, status, and version', () => {
    const service = new CuratedMemorySchemaStoreService();
