...
const HistoryEvaluatorMemoryExtractorService = require('../../../src/application/services/memory/history-evaluator-memory-extractor.service');
...
describe('T167: History Evaluator and Memory-Candidate Extractor Service', () => {
  test('extracts memory candidates only with evidence and without promoting raw logs directly', () => {
    ...
    const service = new HistoryEvaluatorMemoryExtractorService({ immutableHistoryStore: mockStore });
