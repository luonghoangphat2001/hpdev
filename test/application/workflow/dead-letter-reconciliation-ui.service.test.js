...
const DeadLetterReconciliationUiService = require('../../../src/application/services/workflow/dead-letter-reconciliation-ui.service');
...
describe('T132: Retry/Dead-Letter/Reconciliation UI Service', () => {
  test('lists dead letters and triggers dry run replay', async () => {
    ...
    const service = new DeadLetterReconciliationUiService({ deadLetterRepository: mockRepo });
