...
const WorkflowFilterSearchService = require('../../../src/application/services/workflow/workflow-filter-search.service');

describe('T127: Workflow List/Search/Filter Page Service', () => {
  test('filters workflows by agent, status, and risk level', () => {
    const service = new WorkflowFilterSearchService();
    const workflows = [
