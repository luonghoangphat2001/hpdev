...
const WorkflowDetailTimelineService = require('../../../src/application/services/workflow/workflow-detail-timeline.service');
...
describe('T128: Workflow Detail Timeline Service', () => {
  test('returns step-by-step timeline with state transitions and redacted payload', () => {
    const service = new WorkflowDetailTimelineService();
