...
const VersionAwareContextResultCacheService = require('../../../src/application/services/workflow/version-aware-context-result-cache.service');
...
describe('T180: Version-Aware Context/Result Cache Service', () => {
  test('manages version-aware PII-safe cache entries and handles invalidation', () => {
    const service = new VersionAwareContextResultCacheService();
