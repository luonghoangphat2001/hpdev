...
const AgentQuarantineInvestigationService = require('../../../src/application/services/agent/agent-quarantine-investigation.service');
...
describe('T145: Agent Quarantine and Investigation Mode Service', () => {
  test('quarantines agent, revokes credentials, preserves evidence, and opens investigation', () => {
    ...
    const service = new AgentQuarantineInvestigationService({ lifecycleStateMachineService: mockSm });
