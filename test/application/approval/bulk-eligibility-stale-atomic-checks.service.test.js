...
const BulkEligibilityStaleAtomicChecksService = require('../../../src/application/services/approval/bulk-eligibility-stale-atomic-checks.service');
...
describe('T192: Bulk Eligibility, Stale, and Atomic Consume Checks Service', () => {
  test('rechecks payload hash and resource version per item, ensuring safe partial results', () => {
    const service = new BulkEligibilityStaleAtomicChecksService({});
