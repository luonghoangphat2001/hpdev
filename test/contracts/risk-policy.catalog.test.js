...
const riskPolicyCatalog = require('../../src/contracts/policies/risk-policy.catalog');
const {
  RiskPolicyCatalog,
  APPROVAL_MODES,
  DEFAULT_DENY_POLICY,
  DEFAULT_THRESHOLDS,
} = require('../../src/contracts/policies/risk-policy.catalog');

describe('RiskPolicyCatalog', () => {
  ...
  it('fails startup when an allowlisted action lacks a policy', () => {
    expect(() => new RiskPolicyCatalog([], actionCatalog.list()))
