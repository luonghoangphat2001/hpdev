/**
 * @fileoverview crawl.service - Provides crawl functionality.
 */
'use strict';
...
class CrawlService {
  ...
  /**
   * crawlWithBrowser - Asynchronously executes crawl with browser.
   * @param {*} url - Input parameter.
   * @returns {*} Promise resolving result.
   */
  ...
  /**
   * crawlWithHttp - Asynchronously executes crawl with http.
   * @param {*} url - Input parameter.
   * @returns {*} Promise resolving result.
   */
