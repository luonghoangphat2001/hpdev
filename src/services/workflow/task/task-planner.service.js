/**
 * @fileoverview task-planner.service - Provides task-planner functionality.
 */
'use strict';
...
class TaskPlannerService {
  constructor({
    ...
    if (!planningEngine || typeof planningEngine.decompose !== 'function') {
      throw new TypeError('TaskPlannerService requires a decomposition engine');
    }
...
module.exports = TaskPlannerService;
