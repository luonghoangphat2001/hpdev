/**
 * @fileoverview cfo.agent - Provides cfo.agent functionality.
 */
'use strict';

const BaseProposalAgent = require('./base-proposal.agent');
const AnalysisService = require('./cfo/analysis.service');

/**
 * CfoAgent
 * Manages cfo agent logic.
 */
class CfoAgent extends BaseProposalAgent {
  ...
  /**
   * reconcile - Asynchronously executes reconcile.
