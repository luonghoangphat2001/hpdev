/**
 * @fileoverview operator-control.service - Provides operator-control functionality.
 */
'use strict';
...
class OperatorControlService {
  ...
  /**
   * control - Asynchronously executes control.
  ...
  /**
   * feedback - Asynchronously executes feedback.
   * @param {*} command - Input parameter.
   * @returns {*} Promise resolving result.
   */
