/**
 * @fileoverview EnvReader - Single responsibility parser and validator for environment variables in OpenClaw.
 * Fail-fast with clear descriptive errors and zero || operators.
 */
'use strict';
