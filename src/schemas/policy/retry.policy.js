/**
 * @fileoverview retry.policy - Provides retry functionality.
 */
'use strict';
...
/**
 * ErrorRetryPolicy
 * Manages error retry policy logic.
 */
class ErrorRetryPolicy {
  ...
  /**
   * getErrorPolicy - Executes get error policy.
  ...
  /**
   * getCallPolicy - Executes get call policy.
  ...
  /**
   * canRetry - Executes can retry.
   * @param {*} errorCode - Input parameter.
   * @param {*} actionName - Input parameter.
   * @param {*} attempt - Input parameter.
   * @param {*} hasIdempotencyKey - Input parameter.
   * @returns {*} Result of operation.
   */
