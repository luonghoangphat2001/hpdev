/**
 * @fileoverview memory-policy - Provides memory-policy functionality.
 */
'use strict';
...
/**
 * MemoryPolicy
 * Manages memory policy logic.
 */
class MemoryPolicy extends BasePolicy {
  constructor({
    clock = () => new Date(),
    idFactory = () => `mem_${crypto.randomUUID()}`,
  } = {}) {
    super({ name: 'MemoryPolicy' });
