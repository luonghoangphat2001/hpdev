...
$calculator_text          = '';
?>
<div class="t-gr woocommerce-shipping-totals shipping">
	<span class="fw-6"><?php echo wp_kses_post( $package_name ); ?></span>
	<span class="fw-6" data-title="<?php echo esc_attr( $package_name ); ?>">
