...
class Hp_Widget_Callback {
    ...
    {
        $message = [
            'title' => __( 'Không tồn tại loại trường dữ liệu ['.esc_attr( $fiele_name ).']. Hãy sử dụng các kiểu dữ liệu được cho phép bên dưới:', 'HPmedia' ),
            'allows' => self::get_regsiter_field(),
        ];
        ?>
        <div class="hp-widget-not-found">
            <div class="w-title">
