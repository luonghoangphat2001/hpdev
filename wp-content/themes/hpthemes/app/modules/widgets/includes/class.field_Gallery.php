...
class Render_Field_Gallery {
    ...
    public function render( $field_args = [] ) 
    {
        ...
        if ( isset ( $field_args['title'] ) ) {
            ...
            $widget_title = __( 'Gallery', 'HPmedia' );
        }
        ...
        if ( isset ( $field_args['class'] ) ) {
            $class = 'hp-custom-widget ref-field-gallery '.esc_attr( $field_args['class'] ).'';
        } else {
            $class = 'hp-custom-widget ref-field-gallery';
        }
        ...
        $output .= '<div class="hp-widget-items render-field box-field-gallery">';
    ...
    public function get_docs() 
    {
        ...
        <pre>
            ...
            // Cập nhật
            $instance['gallery'] = hp_update_field_settings( $new_instance['gallery'] );
            </code>
            </pre>
        <?php
    }
