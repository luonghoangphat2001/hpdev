...
class Render_Field_Group {
    ...
    public function render( $field_args = [] ) 
    {
        ...
        $output .= '<div class="hp-widget-items render-field box-field-group">';
        ...
        foreach ( $field_args['fields'] as $key => $item ) {
            ...
            if ( $item['type'] == 'text' ) {
                ...
                if ( isset ( $item['class'] ) ) {
                    $gallery_class = 'hp-custom-widget ref-field-gallery '.$item['class'].'';
                } else {
    ...
    public function get_docs() 
    {
        ...
        <pre>
            ...
            // Cập nhật
            $instance['group'] = $this->Hp_Widget->update_field( $new_instance['group'] );
            </code>
        </pre>
        <?php
    }
