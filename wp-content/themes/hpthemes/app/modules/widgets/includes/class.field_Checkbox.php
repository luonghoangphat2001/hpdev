...
class Render_Field_Checkbox {
    ...
    public function render( $field_args = [] ) 
    {
        ...
        if ( isset ( $field_args['title'] ) ) {
            ...
            $widget_title = __( 'Checkbox', 'HPmedia' );
        }
        ...
        if ( isset ( $field_args['class'] ) ) {
            $class = 'class="hp-custom-widget ref-field-checkbox '.$field_args['class'].'"';
        } else {
        ...
        $output .= '<div class="hp-widget-items render-field box-field-checkbox">';
        ...
        <pre>
            ...
            hp_render_field_settings(
                [
                    ...
                    'value'        => $checkbox,
                    'title'        => __( 'Checkbox', 'HPmedia' ),
                    'placeholder'  => __( 'Chọn giá trị', 'HPmedia' ),
                    'checkbox' => [
                        'checkbox_1'  => __( 'Giá trị 1', 'HPmedia' ),
                        'checkbox_2'  => __( 'Giá trị 2', 'HPmedia' ),
                        'checkbox_3'  => __( 'Giá trị 3', 'HPmedia' ),
                    ],
                    'column'       => 4, // max 5
                    'docs'         => false,
                ]
            ...
            // Cập nhật
            $instance['checkbox'] = hp_update_field_settings( $new_instance['checkbox'] );
            </code>
        </pre>
        <?php
    }
