jQuery(document).ready(function($) {
    ...
    $(document).on('click', '.remove_image_button', function(e) {
        ...
        var default_src = $button.closest('.box-field-image').find('.w-image-review').attr('default-src');
        if ( default_src != '' ) {
            $button.closest('.box-field-image').find('.w-image-review').attr('src', default_src);
        } else {
    ...
    $(document).on('click', '.add_row_button', function(e) {
        ...
        $clone.find('img').each(function() {
            var $this = $(this);
            var default_src = $this.attr('default-src');
            if ( default_src != '' ) {
