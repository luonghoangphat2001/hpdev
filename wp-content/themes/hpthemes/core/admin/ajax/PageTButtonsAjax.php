<?php 
add_action( 'wp_ajax_Hp_Admin_ajax_update_buttons',  'Hp_Admin_ajax_update_buttons' ); // login
function Hp_Admin_ajax_update_buttons() {
    try {
        $formdata = isset( $_POST ) ? $_POST : [];
        // check class 
        $callBack = (new Hp_Setting_Buttons());
