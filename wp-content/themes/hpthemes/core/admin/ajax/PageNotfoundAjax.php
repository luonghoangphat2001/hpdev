<?php 
add_action( 'wp_ajax_Hp_Admin_ajax_update_notfound',  'Hp_Admin_ajax_update_notfound' ); // login
function Hp_Admin_ajax_update_notfound() {
    try {
        $formdata = isset( $_POST ) ? $_POST : [];
        // check class 
        $callBack = (new Hp_Setting_Not_Found());
