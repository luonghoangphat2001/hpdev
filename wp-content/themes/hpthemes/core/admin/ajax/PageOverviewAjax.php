<?php 
add_action( 'wp_ajax_Hp_Admin_ajax_update_overview',  'Hp_Admin_ajax_update_overview' ); // login
function Hp_Admin_ajax_update_overview() {
    try {
        $formdata = isset( $_POST ) ? $_POST : [];
        // check class 
        $callBack = (new Hp_Setting_Overview());
